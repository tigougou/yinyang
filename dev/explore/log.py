...
def log(hwnd,account = "",password = "",region = 0):
    ...
    if(account != ""):
        ...
        if(find == 0):
            ...
            find_pic_loop(r"log/dianjijinru.bmp", click_en=1, offsetx=0, offsety=0, wait_delta=1, times=1,
                          success_image="log/logqueren.bmp|log/logqueren1.bmp|log/fanhui.bmp", sim=0.9)
            print("log success")
            return 1
    else:
        ...
        find_pic_loop(r"log/dianjijinru.bmp", click_en=1, offsetx=0, offsety=0, wait_delta=1, times=1,success_image="log/logqueren.bmp|log/logqueren1.bmp|log/fanhui.bmp",sim = 0.9)
        print("log success")
        return 1
